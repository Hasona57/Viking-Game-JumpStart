...
/** @type {string} */
const CACHE_VERSION = '1756051547|69405378333';
/** @type {string} */
const CACHE_PREFIX = 'JumpStart Red Se-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Viking.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Viking.html","Viking.js","Viking.offline.html","Viking.icon.png","Viking.apple-touch-icon.png","Viking.audio.worklet.js","Viking.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Viking.wasm","Viking.pck","Viking.side.wasm"];
